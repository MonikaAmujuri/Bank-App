...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-5xl overflow-hidden rounded-[32px] bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] grid md:grid-cols-2">
        {/* Left branding panel */}
        <div className="hidden md:flex flex-col justify-between bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 p-10 text-white">
          <div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">MyBank Admin</h1>
                <p className="text-sm text-indigo-100">Secure Control Panel</p>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <p className="mt-4 max-w-md text-indigo-100">
                Access customer records, loan operations, agent management, and
                secure admin controls from one premium workspace.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <p className="mt-1 text-sm text-white/90">
                Manage users, agents, loans, and profile settings seamlessly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-10 md:p-12">
          <div className="mb-8 text-center md:text-left">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 text-2xl font-bold text-white shadow-md md:mx-0 md:hidden">
              M
            </div>
