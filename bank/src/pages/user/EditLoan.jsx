    ...
    const fetchLoan = async () => {
      try {
        ...
        setFormData({
          ...
          institutionName: data.educationDetails?.institutionName || "",
          courseName: data.educationDetails?.courseName || "",
          courseDuration: data.educationDetails?.courseDuration || "",
          instituteLocation: data.educationDetails?.instituteLocation || "",
          courseFee: data.educationDetails?.courseFee || "",
          studyYear: data.educationDetails?.studyYear || "",
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="tenure"
                  value={formData.tenure ? `${formData.tenure} Months` : ""}
                  readOnly
                  className="w-full rounded-xl border border-gray-300 bg-gray-100 px-4 py-3 text-gray-600 outline-none"
                />
              </div>
                ...
                {isEducationLoan ? (
                  <>
                    <div>
                      ...
                      />
                      <p className="mt-2 text-xs text-gray-500">
                        Leave empty to keep existing admission letter
                      </p>
                    </div>

                    <div>
                      <label className="mb-2 block text-sm font-medium text-gray-700">
                        Replace Fee Structure / Fee Receipt
                      </label>
                      <input
                        type="file"
                        name="feeStructure"
                      ...
                      />
                      <p className="mt-2 text-xs text-gray-500">
                        Leave empty to keep existing fee structure
                      </p>
                    </div>

                    <div className="md:col-span-2">
                      <label className="mb-2 block text-sm font-medium text-gray-700">
                        Replace Academic Marksheets
                      </label>
                      <input
                        type="file"
                        name="marksheets"
                      ...
                      />
                      <p className="mt-2 text-xs text-gray-500">
                        Select files only if you want to replace existing marksheets
                      </p>
                    </div>
                  </>
                ) : (
