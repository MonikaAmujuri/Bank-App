...
const Login = () => {
  ...
  const redirectByRole = (user) => {
    if (user.role === "user") {
      ...
      setError("Only users can access this customer portal");
    }
  };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 px-4 py-10">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[32px] bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] md:grid-cols-2">
        {/* Left Panel */}
        <div className="hidden md:flex flex-col justify-between bg-gradient-to-br from-indigo-400 via-blue-400 to-cyan-400 p-10 text-white">
          <div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">MyBank Customer</h1>
                <p className="text-sm text-indigo-100">Personal Banking</p>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <h2 className="text-4xl font-bold leading-tight">
                Sign in to manage your loans and profile
              </h2>
              <p className="mt-4 max-w-md text-indigo-100">
                Access your dashboard, track loan applications, manage your
                profile, and stay updated from one beautiful customer workspace.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-4">
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-sm font-medium text-indigo-100">Secure Access</p>
            ...
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <p className="mt-1 text-sm text-white/90">
                View your account, manage applications, and access your banking
                journey smoothly.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleContinue} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-gray-200 px-4 py-3 outline-none transition focus:border-indigo-400"
                value={identifier}
                onChange={(e) => {
