  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-12 px-6 py-20 md:flex-row md:py-24">
          <div className="max-w-2xl">
            ...
            <p className="mb-8 max-w-xl text-lg leading-8 text-gray-600">
              ...
              designed to support your education, home, personal, and vehicle needs.
            </p>
            ...
            <div className="rounded-3xl bg-white p-8 shadow-2xl ring-1 ring-gray-100">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl bg-blue-50 p-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900">Quick access to funds</p>
                </div>

                <div className="rounded-2xl bg-gray-50 p-4">
                  <p className="text-sm text-gray-500">Home Loan</p>
                  <p className="text-lg font-semibold text-gray-900">Affordable repayment plans</p>
                </div>

                <div className="rounded-2xl bg-cyan-50 p-4">
                  <p className="text-sm text-gray-500">Education Loan</p>
                  <p className="text-lg font-semibold text-gray-900">Support your future goals</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 md:grid-cols-2">
          <div>
            ...
            <p className="mb-6 text-lg leading-8 text-gray-600">
              ...
              that help you achieve life goals with confidence. From personal needs
              to home ownership and education support, our bank is here to guide you.
            </p>

            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="mb-2 text-lg font-semibold text-blue-900">Fast Approval</h3>
              ...
              <div className="rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="mb-2 text-lg font-semibold text-blue-900">Low Documentation</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="mb-2 text-lg font-semibold text-blue-900">Flexible EMI</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="mb-2 text-lg font-semibold text-blue-900">Trusted Support</h3>
                <p className="text-sm text-gray-600">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-blue-900 to-blue-700 p-8 text-white shadow-xl">
            <h3 className="mb-4 text-2xl font-bold">Why customers trust us</h3>
            <p className="mb-6 text-blue-100">
              Our goal is to make banking and loans easier, safer, and more accessible
              for every customer.
            </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {loanTypes.map((loan, index) => (
              ...
              >
                ...
                <h3 className="mb-3 text-xl font-semibold text-gray-900">{loan.title}</h3>
                <p className="mb-6 text-gray-600">{loan.description}</p>
                <Link
                  to="/login"
      ...
      <section className="py-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="rounded-3xl bg-blue-900 px-8 py-14 text-center text-white shadow-xl md:px-16">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-3">
          <div>
            ...
            <p className="text-gray-600">
              Secure, trusted, and customer-focused banking solutions for every need.
            </p>
          </div>

          <div>
            <h4 className="mb-3 text-lg font-semibold text-gray-900">Quick Links</h4>
