            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              >
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  >
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-100 text-xl">
                      📄
                    </div>
                  ...
                  >
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-100 text-xl">
                      📂
                    </div>
                    <h3 className="text-lg font-semibold text-blue-900">
                      Uploaded Documents
                  ...
                  >
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-100 text-xl">
                      💬
                    </div>
                    <h3 className="text-lg font-semibold text-blue-900">
                      Need Help?
